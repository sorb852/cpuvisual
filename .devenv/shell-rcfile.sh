...
source "/home/sorb852/files/school/cpuvisual/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/tmp/devenv-reload-38261.sh" ]; then
        ...
        source "/tmp/devenv-reload-38261.sh"
        rm -f "/tmp/devenv-reload-38261.sh"
